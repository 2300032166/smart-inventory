...
async def generate_reasoning(prompt: str) -> str:
    ...
    timeout_seconds = float(cfg.get("groq_timeout_seconds", os.getenv("GROQ_TIMEOUT_SECONDS", "4")))
    max_tokens = int(cfg.get("groq_max_tokens", os.getenv("GROQ_MAX_TOKENS", "40")))
